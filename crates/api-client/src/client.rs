...
impl ApiClient {
    ...
    pub async fn list_sessions(&self, query: &SessionListQuery) -> Result<SessionListResponse> {
        ...
        if let Some(ref t) = query.team_id {
    ...
    pub async fn list_members(&self, team_id: &str) -> Result<ListMembersResponse> {
        ...
        let resp = self
            .client
            .get(self.url(&format!("/teams/{team_id}/members")))
            .bearer_auth(token)
            .send()
            .await?;
        parse_response(resp).await
    ...
    pub async fn remove_member(&self, team_id: &str, user_id: &str) -> Result<OkResponse> {
        ...
        let resp = self
            .client
            .delete(self.url(&format!("/teams/{team_id}/members/{user_id}")))
            .bearer_auth(token)
            .send()
            .await?;
        parse_response(resp).await
    ...
    pub async fn accept_invitation(&self, id: &str) -> Result<AcceptInvitationResponse> {
        ...
        let resp = self
            .client
            .post(self.url(&format!("/invitations/{id}/accept")))
            .bearer_auth(token)
            .send()
            .await?;
        parse_response(resp).await
    ...
    pub async fn decline_invitation(&self, id: &str) -> Result<OkResponse> {
        ...
        let resp = self
            .client
            .post(self.url(&format!("/invitations/{id}/decline")))
            .bearer_auth(token)
            .send()
            .await?;
        parse_response(resp).await
    ...
    pub async fn invite_member(&self, team_id: &str, req: &InviteRequest) -> Result<OkResponse> {
        ...
        let resp = self
            .client
            .post(self.url(&format!("/teams/{team_id}/invite")))
            .bearer_auth(token)
            .json(req)
            .send()
            .await?;
    ...
    pub async fn sync_pull(
        ...
        let token = self.token_or_bail()?;
        let mut url = format!("{}?team_id={team_id}", self.url("/sync/pull"));
    ...
    pub async fn config_sync(&self, team_id: &str) -> Result<ConfigSyncResponse> {
        ...
        let resp = self
            .client
            .get(self.url(&format!("/teams/{team_id}/config")))
            .bearer_auth(token)
            .send()
            .await?;
        parse_response(resp).await
