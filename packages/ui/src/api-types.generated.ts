...
export interface DesktopQuickShareRequest { session_id: string, remote?: string | null, }

export interface DesktopQuickShareResponse { source_uri: string, shared_uri: string, remote: string, push_cmd: string, pushed: boolean, auto_push_consent: boolean, }
...
export type DesktopSummaryBatchExecutionMode = "manual" | "on_app_start"

export type DesktopSummaryBatchScope = "recent_days" | "all"
...
export interface DesktopRuntimeSummaryBatchSettings { execution_mode: DesktopSummaryBatchExecutionMode, scope: DesktopSummaryBatchScope, recent_days: number, }

export interface DesktopRuntimeSummarySettings { provider: DesktopRuntimeSummaryProviderSettings, prompt: DesktopRuntimeSummaryPromptSettings, response: DesktopRuntimeSummaryResponseSettings, storage: DesktopRuntimeSummaryStorageSettings, source_mode: DesktopSummarySourceMode, batch: DesktopRuntimeSummaryBatchSettings, }
...
export interface DesktopRuntimeSummaryBatchSettingsUpdate { execution_mode: DesktopSummaryBatchExecutionMode, scope: DesktopSummaryBatchScope, recent_days: number, }

export interface DesktopRuntimeSummarySettingsUpdate { provider: DesktopRuntimeSummaryProviderSettingsUpdate, prompt: DesktopRuntimeSummaryPromptSettingsUpdate, response: DesktopRuntimeSummaryResponseSettingsUpdate, storage: DesktopRuntimeSummaryStorageSettingsUpdate, source_mode: DesktopSummarySourceMode, batch: DesktopRuntimeSummaryBatchSettingsUpdate, }
...
export type DesktopSummaryBatchState = "idle" | "running" | "complete" | "failed"

export interface DesktopSummaryBatchStatusResponse { state: DesktopSummaryBatchState, processed_sessions: number, total_sessions: number, failed_sessions: number, message?: string | null, started_at?: string | null, finished_at?: string | null, }
...
export interface DesktopRuntimeSettingsResponse { session_default_view: string, summary: DesktopRuntimeSummarySettings, vector_search: DesktopRuntimeVectorSearchSettings, change_reader: DesktopRuntimeChangeReaderSettings, lifecycle: DesktopRuntimeLifecycleSettings, ui_constraints: DesktopRuntimeSummaryUiConstraints, }

export interface DesktopRuntimeSettingsUpdateRequest { session_default_view?: string | null, summary?: DesktopRuntimeSummarySettingsUpdate | null, vector_search?: DesktopRuntimeVectorSearchSettingsUpdate | null, change_reader?: DesktopRuntimeChangeReaderSettingsUpdate | null, lifecycle?: DesktopRuntimeLifecycleSettingsUpdate | null, }
